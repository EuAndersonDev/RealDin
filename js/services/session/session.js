const SessionService = (() => {
  ...
  function syncLegacyQuizKeys(quizState) {
    ...
    sessionStorage.setItem(LEGACY_SCORE_KEY, JSON.stringify(quizState.scores || { ...QUIZ_DEFAULT_SCORES }));
    sessionStorage.setItem(LEGACY_FINISHED_KEY, quizState.isFinished ? 'true' : 'false');
  }
